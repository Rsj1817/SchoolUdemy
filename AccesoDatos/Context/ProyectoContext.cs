...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=proyecto;User Id=sa;Password=Rootroot1!;TrustServerCertificate=True;MultipleActiveResultSets=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FA54B5137");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FCB4CA242");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FF477D5E0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83FBAF81F17");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7530B1A26");
